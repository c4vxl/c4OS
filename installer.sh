...
PACKAGES="base linux linux-firmware bash nano sudo networkmanager bluez-utils bluez cups grub efibootmgr git xorg base-devel wget python-pip pipewire pipewire-pulse vala gparted arch-install-scripts $FONT_PACKAGES"
FL_SCRIPTS=""
KEEP_FLS=false
EXEC=""
