...
PACKAGES="base linux linux-firmware bash nano sudo networkmanager bluez-utils bluez cups ghostscript neofetch grub efibootmgr git xorg git base-devel wget python-pip gparted $FONT_PACKAGES"
FL_SCRIPTS=""
KEEP_FLS=false
EXEC=""
